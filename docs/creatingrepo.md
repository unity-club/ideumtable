...
This guide will show you how to create a GitHub repository for your app on GitHub for Unity Club.
...
3. Choose whether to make your repository public or private. It is best to leave this as **Public**. Private repositories will only be visible by you and the people you are working with, but know that if you do not have a [GitHub pro](https://github.com/pricing) or an [education account](https://help.github.com/en/github/teaching-and-learning-with-github-education/applying-for-a-student-developer-pack), you will only be able to have at most three collaborators who can access your repository.
4. Make sure to check **Initialize this repository with a README**.
...
If you've never used GitHub Desktop before, follow the steps to log in and get going. If you've already used Git or GitHub Desktop, feel free to skip these steps.
...
```
 ...
 Now you are ready to start developing your app in Unity! But first, you should push your changes to the server.
